        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h2>Contact Us<br></h2>
                    <p class="router-p">
                        A stone’s throw from your one-stop real estate experience.
                    </p>
                    <P class="router-p-1">A committed team of real estate experts is available to assist you whether
                        you’re attempting to
                        sell, locate your new dream home, maximize the yield on your property investment, or require
                        maintenance for your rental property.</P>
                </div>
            </div>
        </div>
    </section>
